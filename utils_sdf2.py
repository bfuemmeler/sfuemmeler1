...
min_score: float = min(employee_rating)  
max_score: float = max(employee_rating)  
mean_score: float = statistics.mean(employee_rating)  
stdev_score: float = statistics.stdev(employee_rating)
